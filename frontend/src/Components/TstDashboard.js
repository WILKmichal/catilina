...
function Dash() {
        ...
        //const Statut = useAxiosGet(url)
        const url = 'https://5f3be1fcfff8550016ae5d56.mockapi.io/Projet/Dashboard'


        let Dashboard = async (e) => {

            //const affiche = { "STS":Sts };
            const affiche = { "STATUT": STATUT };
            const axios = await useAxiosGet.get('https://5f3be1fcfff8550016ae5d56.mockapi.io/Projet/Dashboard')
