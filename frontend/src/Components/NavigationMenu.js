        ...
        <nav className="flex bg-teal-100 text-white p-1 ">
          ...
          <div className="items-center flex">
            ...
            <div className="flex float-right text-md">
              <a className="m-20 bg-white text-teal-500 font-semibold border-gray-100 rounded hover:border-teal-500 hover:bg-gray-100"><LoginSliderRight /></a>
              <a className="m-20 bg-teal-500 text-gray-100 font-semibold border-teal-600 rounded hover:border-white hover:bg-teal-600"><RegisterSliderRight /></a>
            </div>
          </div>
        </nav>
      </header>
